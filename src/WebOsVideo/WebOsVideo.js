...
//                    videoElement.currentTime = commandArgs.time !== null && isFinite(commandArgs.time) ? parseInt(commandArgs.time) / 1000 : 0;
                    getContentType(commandArgs.stream)
                        .then(function(contentType) {
                            ...
                            if ('MediaSource' in window) {
                                ...
                                mediaSource.onsourceopen = function(event) {
                                    ...
                                    var sourceBuffer = mediaSource.addSourceBuffer(contentType);
        ...
        //                            }
                                    fetch(commandArgs.stream.url, { method: 'GET', redirect: 'follow'})
                                        .then(function(resp) {
                                ...
                                console.log('using normal video');
                            ...
                            onPropChanged('duration');
                            onPropChanged('buffering');
                        }).catch(function(e) { console.log('ee'); console.error(e); })
                }
...
WebOsVideo.manifest = {
    ...
    props: ['stream', 'paused', 'time', 'duration', 'buffering', 'volume', 'muted']
};
